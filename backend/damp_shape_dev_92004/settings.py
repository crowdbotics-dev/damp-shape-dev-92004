"""
Django settings for damp_shape_dev_92004 project.
...
ROOT_URLCONF = 'damp_shape_dev_92004.urls'
...
WSGI_APPLICATION = 'damp_shape_dev_92004.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_shape_dev_92004 API",
    "DESCRIPTION": "API documentation for damp_shape_dev_92004 App",
    "VERSION": "v1",
}
